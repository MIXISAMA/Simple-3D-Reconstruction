...
TextureMeshView::TextureMeshView(OutputFileWindow::Context* outputContext) :
    IContext(outputContext),
    plyViewerWindow_(),
    operateWindow_(std::bind(&TextureMeshView::onMvsCallback_, this)),
    mvs_(),
    mvsFuture_()
{
...
void TextureMeshView::onMvsCallback_()
{
